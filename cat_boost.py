...
# Beispiel: Text in numerische Features umwandeln (falls noch nicht geschehen)
from sklearn.feature_extraction.text import CountVectorizer
vectorizer = CountVectorizer(max_features=5000)  # Maximal 5000 häufigste Wörter
X = vectorizer.fit_transform(filtered_posts['title']).toarray()  # Features aus Titel
y = filtered_posts['classification']  # Labels (pro-Trump, pro-Harris, neutral)
...
# Optional: Confusion-Matrix visualisieren
